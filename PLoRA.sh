...
lr_warmup_steps=0                   
lr_restart_cycles=1                 
output_name="pokemon_lora_mia_vanilla_alpha005_analysis_v3_"           
...
python -m accelerate.commands.launch ${launchArgs[@]} --num_cpu_threads_per_process=8 "./sd-scripts/plora.py" \
  --enable_bucket \
